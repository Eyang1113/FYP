...
if(isset($_GET['string_id'])) {
    ...
    if(!empty($row)){
        ...
        $string_category = $row["string_category"];
        $string_stock = $row["string_stock"];
        ...
        <div class="product-details">
            ...
            <div class="product-info">
                ...
                <form action="" method="post">
                    <input type="hidden" name="string_category" value="<?php echo $string_category; ?>">
...
if (isset($_POST["add_to_cart"])) {
    ...
    $string_category = $_POST['string_category'];
    ...
    $balance = $string_stock - $quantity;
    if ($balance >= 0) {
        mysqli_query($connect, "INSERT INTO cart(product_id, product_name, product_price, product_image, quantity, total_price, user_id, product_category) VALUES ('$string_id', '$string_name', '$string_price', '$string_image', '$quantity', '$total', '$user_id', '$string_category')");
