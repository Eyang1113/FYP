...
if (isset($_POST['add_to_cart'])) {
    ...
    $insert_cart_sql = "INSERT INTO cart(product_id, product_name, product_price, product_image, quantity, total_price, user_id) VALUES ('$clothes_id', '$clothes_name', '$clothes_price', '$clothes_image', '$quantity', '$total', '$user_id')";
