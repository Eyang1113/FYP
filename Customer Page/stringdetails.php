...
if(isset($_POST['add_to_cart'])) {
    ...
    $insert_cart_sql = "INSERT INTO cart(product_id, product_name, product_price, product_image, quantity, total_price) VALUES ('$string_id', '$string_name', '$string_price', '$string_image', '$quantity', '$total')";
