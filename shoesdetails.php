        ...
        <div class="product-details">
            ...
            <div class="product-info">
                ...
                <form action="" method="post">
                    <input type="hidden" name="shoe_category" value="<?php echo $shoe_category; ?>">
...
if (isset($_POST["add_to_cart"])) {
    ...
    $balance = $shoe_stock - $quantity;
    if ($balance >= 0) {
        mysqli_query($connect, "INSERT INTO cart(product_id, product_name, product_price, product_image, quantity, total_price, user_id, product_category) VALUES ('$shoe_id', '$shoe_name', '$shoe_price', '$shoes_image', '$quantity', '$total', '$user_id', '$shoe_category')");
